...
img_dir = './img/Memorial_SourceImages/'
save_dir = img_dir + 'hdr/'
call(['mkdir', save_dir])
img_fn = [img_dir+'memorial00'+str(i)+".png" for i in range(61,77)]
img_list = [spm.imread(fn) for fn in img_fn]
exposure_times = [1/0.03125,1/0.0625,1/0.125,1/0.25,1/0.5,1,1/2,1/4,1/8,1/16,1/32,1/64,1/128,1/256,1/512,1/1024]
# with open("memorial.hdr_image_list.txt", "r") as f:
#     for line in f:
...
tone_img = globalToneMapping(rad_map, 1.5)
